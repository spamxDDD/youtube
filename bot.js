...
client.on('guildMemberAdd', (member) => {
member.addRole(member.guild.roles.find('name', 'online'));
});
 
 
client.on('message', message => {                      
...
                                                       
                               active.on("collect", r => {
                                   message.member.addRole(message.guild.roles.find("name", "s"));
                                   message.member.removeRole(message.guild.roles.find("name", "online"));
                                   msg.delete();
